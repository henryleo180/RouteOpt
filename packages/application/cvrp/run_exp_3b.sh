...
# u_values=(217 745 793 969 828 628 27592)

# add 1%
# u_values=(219 752 801 979 836 634 27868 12875 15122)
u_values=(219 752 801 979 836 634 27868)
...
for i in "${!vrp_files[@]}"; do
    ...
    ./asaved_exe/cvrp_3b "$file" -u "$u" > "/home/haoran/solver/DataCollect/logs/output3b_ub1_${base}.txt" 2>&1
