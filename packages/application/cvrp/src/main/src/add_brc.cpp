...
namespace RouteOpt::Application::CVRP {
        ...
        std::vector<BbNode*>& children)
    {
        ...
        static constexpr int MAX_3WAY_ROUNDS = 100;
...
// std::vector<int> e1_inds; std::vector<double> e1_vals;
// std::vector<int> e2_inds; std::vector<double> e2_vals;
//         node->obtainBrcCoefficient(e1, e1_inds, e1_vals);
//         node->obtainBrcCoefficient(e2, e2_inds, e2_vals);
        ...
        // Branch B: enforce e1 = 0 and e2 = 0
        {
            ...
            int row1;
            SAFE_SOLVER(node->refSolver().getNumRow(&row1));
            Brc bf1{ e1, row1, /*br_dir=*/false , false };
            ...
            Brc bf2{ e2, row2, /*br_dir=*/false , false };
        ...
        // Branch C: enforce x_e1 + x_e2 = 1
        {
            ...
            if (three_way_count <= MAX_3WAY_ROUNDS) {
                ...
                Brc bf1{ e1, row, /*br_dir=*/true , true};
                ...
                // ----------------------------------------------------
                Brc bf2{ e2, row, /*br_dir=*/true , true};
